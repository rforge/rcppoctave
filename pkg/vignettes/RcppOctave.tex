...
\bibliography{/tmp/Rpkglib_7fa932e0b09/RcppOctave/REFERENCES}
...
\begin{verbatim}
## List of 3
##  $ d: num [1:5] 2.59 0.895 0.447 0.239 0.137
##  $ u: num [1:5, 1:5] -0.604 -0.495 -0.342 -0.305 -0.424 ...
##  $ v: num [1:5, 1:5] -0.356 -0.535 -0.38 -0.507 -0.43 ...
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
## [1] "Component 1: Mean relative difference: 4.717e-16"
## [2] "Component 2: Mean relative difference: 6.872e-16"
## [3] "Component 3: Mean relative difference: 6.055e-16"
\end{verbatim}
\end{kframe}
\end{knitrout}
