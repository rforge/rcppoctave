...
\bibliography{/tmp/Rpkglib_c4a2eaca155/RcppOctave/REFERENCES}
...
\begin{verbatim}
## List of 3
##  $ d: num [1:5] 2.63 1.183 0.589 0.507 0.172
##  $ u: num [1:5, 1:5] -0.428 -0.353 -0.466 -0.219 -0.654 ...
##  $ v: num [1:5, 1:5] -0.32 -0.431 -0.57 -0.409 -0.469 ...
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
## [1] "Component 1: Mean relative difference: 2.047e-16"
## [2] "Component 2: Mean relative difference: 6.642e-16"
## [3] "Component 3: Mean relative difference: 6.074e-16"
\end{verbatim}
\end{kframe}
\end{knitrout}
...
[1] RcppOctave_0.9 pkgmaker_0.14  registry_0.2   Rcpp_0.10.2   
[5] knitr_1.1     

loaded via a namespace (and not attached):
[1] codetools_0.2-8 digest_0.6.3    evaluate_0.4.3  formatR_0.7    
[5] stringr_0.6.2   tools_2.15.3    xtable_1.7-1   
\end{verbatim}
\end{kframe}
\end{knitrout}
