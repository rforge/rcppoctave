...
\bibliography{/tmp/Rpkglib_6622784310f0/RcppOctave/REFERENCES}
...
\date{\Rpkg{RcppOctave} -- Version 0.9.3
[September 17, 2013]\footnote{This vignette was built using \octave
3.6.4}}
...
\begin{verbatim}
## $a
## [1] 0.37366 0.70621 0.02157 0.21155
## 
## $b
##         [,1]   [,2]   [,3]
## [1,] 0.01981 0.5135 0.2950
## [2,] 0.24087 0.6212 0.8464
## 
## $c
## [1] "some text"
\end{verbatim}
...
\hlkwd{.CallOctave}\hlstd{(}\hlstr{"fun_varargout"}\hlstd{,} \hlkwc{argout} \hlstd{=} \hlnum{2}\hlstd{)}
\end{alltt}
...
\hlkwd{o_get}\hlstd{(}\hlstr{"xxxxx"}\hlstd{)}
\end{alltt}
...
\hlkwd{o_get}\hlstd{(}\hlstr{"aa"}\hlstd{)}
\end{alltt}
...
\hlkwd{o_eval}\hlstd{(}\hlstr{"a=1; b=2"}\hlstd{)}
\end{alltt}
...
\begin{verbatim}
## List of 3
##  $ d: num [1:5] 2.848 0.679 0.541 0.234 0.139
##  $ u: num [1:5, 1:5] -0.346 -0.571 -0.58 -0.237 -0.402 ...
##  $ v: num [1:5, 1:5] -0.508 -0.249 -0.546 -0.515 -0.341 ...
\end{verbatim}
\begin{alltt}
\hlcom{# check results}
...
\end{alltt}
\begin{verbatim}
## [1] "Component 2: Mean relative difference: 3.749e-16"
## [2] "Component 3: Mean relative difference: 3.256e-16"
\end{verbatim}
\end{kframe}
\end{knitrout}
...
[1] RcppOctave_0.9.3 pkgmaker_0.17    registry_0.2     Rcpp_0.10.4     
[5] knitr_1.4.9     
