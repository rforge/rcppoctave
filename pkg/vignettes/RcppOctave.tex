...
\bibliography{/tmp/tmp.qqatIR9xcG/RcppOctave/REFERENCES}
...
\date{\Rpkg{RcppOctave} -- Version 0.8.10
[December  3, 2012]\footnote{This vignette was built using \octave
3.6.1}}
\begin{document}
\maketitle
...
\end{alltt}
\begin{verbatim}
## [1] 0.77546 0.07163 0.87876 0.25949
\end{verbatim}
\begin{alltt}
...
\begin{verbatim}
## $a
## [1] 0.5855 0.8808 0.8860 0.5967
## 
## $b
##        [,1]   [,2]   [,3]
## [1,] 0.6168 0.6278 0.2251
## [2,] 0.3324 0.2875 0.1174
## 
## $c
## [1] "some text"
\end{verbatim}
...
\begin{verbatim}
## List of 3
##  $ d: num [1:5] 3.1092 1.1821 0.6423 0.3121 0.0474
##  $ u: num [1:5, 1:5] -0.509 -0.52 -0.434 -0.487 -0.212 ...
##  $ v: num [1:5, 1:5] -0.436 -0.251 -0.565 -0.407 -0.512 ...
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
## [1] "Component 2: Mean relative difference: 2.751e-16"
## [2] "Component 3: Mean relative difference: 2.988e-16"
\end{verbatim}
\end{kframe}
\end{knitrout}
...
[1] RcppOctave_0.8.10 pkgmaker_0.9.7    Rcpp_0.10.0       stringr_0.6.1    
[5] digest_0.5.2      knitr_0.8        

loaded via a namespace (and not attached):
[1] codetools_0.2-8 evaluate_0.4.2  formatR_0.6     plyr_1.7.1     
[5] tools_2.15.2    xtable_1.7-0   
\end{verbatim}
\end{kframe}
\end{knitrout}
