...
\bibliography{/tmp/Rpkglib_7eb939bc24e3/RcppOctave/REFERENCES}
...
[September 18, 2013]\footnote{This vignette was built using \octave
3.6.4}}
...
\end{alltt}
\begin{verbatim}
## [1] 0.97766 0.66077 0.39235 0.07403
\end{verbatim}
\begin{alltt}
...
\begin{verbatim}
## $a
## [1] 0.08476 0.29407 0.14411 0.65959
## 
## $b
##         [,1]   [,2]   [,3]
## [1,] 0.59865 0.9461 0.2511
## [2,] 0.07656 0.3880 0.9906
## 
## $c
## [1] "some text"
\end{verbatim}
...
\begin{verbatim}
## List of 3
##  $ d: num [1:5] 2.447 0.706 0.6 0.331 0.083
##  $ u: num [1:5, 1:5] -0.445 -0.598 -0.358 -0.315 -0.466 ...
##  $ v: num [1:5, 1:5] -0.417 -0.521 -0.338 -0.318 -0.582 ...
\end{verbatim}
\begin{alltt}
\hlcom{# check results}
...
\end{alltt}
\begin{verbatim}
## [1] "Component 2: Mean relative difference: 4.096e-16"
## [2] "Component 3: Mean relative difference: 2.792e-16"
\end{verbatim}
\end{kframe}
\end{knitrout}
...
[1] RcppOctave_0.10 pkgmaker_0.17   registry_0.2    Rcpp_0.10.4    
[5] knitr_1.4.9    
