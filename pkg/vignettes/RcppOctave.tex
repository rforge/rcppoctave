...
\begin{verbatim}
## List of 3
##  $ d: num [1:5] 2.659 0.795 0.473 0.361 0.237
##  $ u: num [1:5, 1:5] -0.37 -0.471 -0.51 -0.357 -0.503 ...
##  $ v: num [1:5, 1:5] -0.373 -0.433 -0.479 -0.608 -0.272 ...
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
## [1] "Component 2: Mean relative difference: 3.184e-16"
## [2] "Component 3: Mean relative difference: 3.002e-16"
\end{verbatim}
\end{kframe}
\end{knitrout}
