...
\bibliography{/home/renaud/Documents/projects/RcppOctave/pkg/vignettes/tmplib/RcppOctave/REFERENCES}
...
\end{alltt}
\begin{verbatim}
## [1] 0.79584 0.12912 0.97213 0.05214
\end{verbatim}
\begin{alltt}
...
\begin{verbatim}
## $a
## [1] 0.7625 0.2453 0.5028 0.0694
## 
## $b
##        [,1]   [,2]   [,3]
## [1,] 0.1885 0.2771 0.1404
## [2,] 0.5971 0.8621 0.1762
## 
## $c
## [1] "some text"
\end{verbatim}
...
\hlcomment{# remove}
.O$myvar <- NULL
\hlcomment{# this should now throw an error since 'myvar' does not exist anymore}
.O$myvar
\end{alltt}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlcomment{# density of x=5 for Poisson(2)}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: RcppOctave - error in Octave function `eval`.}}\begin{alltt}
.O$a
\end{alltt}
\begin{verbatim}
## [1] 0.8272 0.6628
...
\begin{verbatim}
## List of 3
##  $ d: num [1:5] 2.879 0.696 0.456 0.364 0.107
##  $ u: num [1:5, 1:5] -0.404 -0.281 -0.508 -0.497 -0.503 ...
##  $ v: num [1:5, 1:5] -0.531 -0.228 -0.431 -0.513 -0.466 ...
\end{verbatim}
\begin{alltt}
...
\end{alltt}
\begin{verbatim}
## [1] "Component 1: Mean relative difference: 4.344e-16"
## [2] "Component 2: Mean relative difference: 1.013e-15"
## [3] "Component 3: Mean relative difference: 7.885e-16"
\end{verbatim}
\end{kframe}
\end{knitrout}
...
[1] RcppOctave_0.8.14 pkgmaker_0.11     Rcpp_0.10.2       knitr_1.0.5      

loaded via a namespace (and not attached):
[1] codetools_0.2-8 digest_0.6.2    evaluate_0.4.3  formatR_0.7    
[5] stringr_0.6.2   tools_2.15.2    xtable_1.7-0   
\end{verbatim}
\end{kframe}
\end{knitrout}
